        ...
        <div   id="courses-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-xl-2">
                    <div class="course">
                        <a href="#" class="course-img">
                            <img src="./img/estadistica.jpg" alt="" style="width:90%">
                            <i class="course-link-icon fa fa-link"></i>
                        </a>
                        <a class="course-title" href="#">Historial Academico</a>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-xl-2">
                    <div class="course">
                        <a href="#" class="course-img">
                            <img src="./img/solicitudes.jpg" alt="">
                            <i class="course-link-icon fa fa-link"></i>
                        </a>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-xl-2">
                    <div class="course">
                        ...
                        <a class="course-title" href="#">Matricula</a>
                        <div class="course-details">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-xl-2">
                    <div class="course">
                        <a href="#" class="course-img">
                            <img style="width:104%" src="./img/lab.jpg" alt="">
                            <i class="course-link-icon fa fa-link"></i>
                        </a>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-xl-2">
                    <div class="course">
                        <a href="#" class="course-img">
                            <img style="width:110%" src="./img/censo.jpg" alt="">
                            <i class="course-link-icon fa fa-link"></i>
                        </a>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-xl-2">
                    <div class="course">
                        <a href="#" class="course-img">
                            <img style="width:118%" src="./img/clavejpg.jpg" alt="">
                            <i class="course-link-icon fa fa-link"></i>
                        </a>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-xl-2">
                    <div class="course">
                        <a href="#" class="course-img">
                            <img style="width:112%" src="./img/notas.jpg" alt="">
                            <i class="course-link-icon fa fa-link"></i>
                        </a>
            ...
            <div  class=" col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4">
                <a href="#" class="img-evalu">
                   <img style="width:20%" src="./img/evaluacionDocente.png" alt="">
            ...
            <div class="col-6 col-xs-4 col-sm-6 col-md-4 col-lg-2 col-xl-2">
                <div class="course">
                    <a href="#" class="course-img">
                        <img  src="./img/evaluacionDocente.png" alt="">
                        <i class="course-link-icon fa fa-link"></i>
                    </a>
